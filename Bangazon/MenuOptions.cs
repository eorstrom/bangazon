...
namespace Bangazon
{
    public class MenuOptions
    {
        public static List<CustomerInfo> AddCustomer()
        {
            ...
            return DatabaseActions.loadCustomers();  // return list that includes newly added customer
        }
        ...
        public static void AddPaymentType(List<CustomerInfo> customerList)
        {
            ...
            int customerIndexChosen = InternalOperations.getChoice();
            ...
            InternalOperations.displayMenu(displayList);
            int paymentTypeIndexChosen = InternalOperations.getChoice();
        ...
        PickAProduct:
            ...
            int productIndexChosen = InternalOperations.getChoice();
